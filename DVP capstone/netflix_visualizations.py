...
# The data is represented by days. Netflix_stocks_quarterly additionally keeps track of yearly quarters, whereas Netflix_stock does not.
...
plt.legend()
plt.title('Earnings and Revenue for 2017')
...
# Revenue and earnings are both rising consistently. Roughly 10% of Netflix's revenue constitutes earnings.
